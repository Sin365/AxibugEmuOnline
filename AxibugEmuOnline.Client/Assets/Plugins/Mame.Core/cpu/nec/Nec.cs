...
namespace cpu.nec
{
    public partial class Nec : cpuexec_data
    {
        ...
        public unsafe delegate* <Nec, void>[] nec_instruction;
        ...
        public byte GetMemB(int Seg, int Off)
        {
            return ReadByte(DefaultBase(Seg, I) + Off);
        }
        public ushort GetMemW(int Seg, int Off)
        {
            return ReadWord(DefaultBase(Seg, I) + Off);
        }
        public void PutMemB(int Seg, int Off, byte x)
        {
            WriteByte(DefaultBase(Seg, I) + Off, x);
        }
        public void PutMemW(int Seg, int Off, ushort x)
        {
        ...
        public void CMP4S(ref int tmp, ref int tmp2)
        {
            int count = (I.regs.b[2] + 1) / 2;
            int i, v1, v2, result;
            ushort di = (ushort)(I.regs.b[14] + I.regs.b[15] * 0x100);
        ...
        public unsafe void nec_init()
        {
            ...
            nec_instruction = new delegate*<Nec, void>[]{
                &NecEx.i_add_br8,
                &NecEx.i_add_wr16,
                &NecEx.i_add_r8b,
                &NecEx.i_add_r16w,
        ...
        public unsafe void nec_trap()
        {
            nec_instruction[fetchop()](this);
    ...
    public class V30 : Nec
    {
        ...
        public unsafe int v30_execute(int cycles)
        {
    ...
    public class V33 : Nec
    {
        ...
        public unsafe int v33_execute(int cycles)
        {
            pendingCycles = cycles;
            while (pendingCycles > 0)
            {
