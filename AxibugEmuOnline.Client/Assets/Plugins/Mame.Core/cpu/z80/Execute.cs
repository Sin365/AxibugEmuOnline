    ...
    public partial class Z80A
    {
        ...
        public override int ExecuteCycles(int cycles)
        {
            ...
            if (nonMaskableInterruptPending)
            {
                ...
                TotalExecutedCycles/*totalExecutedCycles*/ += 11; PendingCycles/*pendingCycles*/ -= 11;
            ...
            do
            {
                        ...
                        case 0:
                            switch (irq_vector & 0xff0000)
                            {
                                case 0xcd0000:
                                    ...
                                    TotalExecutedCycles/*totalExecutedCycles*/ += 19; PendingCycles/*pendingCycles*/ -= 19;
                                    break;
                                case 0xc30000:
                                    RegPC.Word = (ushort)(irq_vector & 0xffff);
                                    TotalExecutedCycles/*totalExecutedCycles*/ += 12; PendingCycles/*pendingCycles*/ -= 12;
                                    break;
                                default:
                                    WriteMemory(--RegSP.Word, RegPC.High); WriteMemory(--RegSP.Word, RegPC.Low);
                                    RegPC.Word = (ushort)(irq_vector & 0x0038);
                                    TotalExecutedCycles/*totalExecutedCycles*/ += (ulong)(cc_op[RegPC.Low] + cc_ex[RegPC.Low]); PendingCycles/*pendingCycles*/ -= cc_op[RegPC.Low] + cc_ex[RegPC.Low];
                                    break;
                            }
                            break;
                        case 1:
                            WriteMemory(--RegSP.Word, RegPC.High); WriteMemory(--RegSP.Word, RegPC.Low);
                            RegPC.Word = 0x38;
                            TotalExecutedCycles/*totalExecutedCycles*/ += 13; PendingCycles/*pendingCycles*/ -= 13;
                            break;
                        case 2:
                            TUS = (ushort)(RegI * 256 + irq_vector);
                            WriteMemory(--RegSP.Word, RegPC.High); WriteMemory(--RegSP.Word, RegPC.Low);
                            RegPC.Low = ReadMemory(TUS++); RegPC.High = ReadMemory(TUS);
                            TotalExecutedCycles/*totalExecutedCycles*/ += 17; PendingCycles/*pendingCycles*/ -= 17;
                            break;
                    }
                    RegWZ.Word = RegPC.Word;
                }

                {
                    ...
                    {
                        case 0x00: // NOP
                            TotalExecutedCycles/*totalExecutedCycles*/ += 4; PendingCycles/*pendingCycles*/ -= 4;
                            break;
                        case 0x01: // LD BC, nn
                            RegBC.Word = (ushort)(ReadOpArg(RegPC.Word++) + ReadOpArg(RegPC.Word++) * 256);
                            TotalExecutedCycles/*totalExecutedCycles*/ += 10; PendingCycles/*pendingCycles*/ -= 10;
                            break;
                        case 0x02: // LD (BC), A
                            WriteMemory(RegBC.Word, RegAF.High);
                            RegWZ.Low = (byte)((RegBC.Word + 1) & 0xFF);
                            RegWZ.High = RegAF.High;
                            TotalExecutedCycles/*totalExecutedCycles*/ += 7; PendingCycles/*pendingCycles*/ -= 7;
                            break;
                        case 0x03: // INC BC
                            ++RegBC.Word;
                            TotalExecutedCycles/*totalExecutedCycles*/ += 6; PendingCycles/*pendingCycles*/ -= 6;
                            break;
                        case 0x04: // INC B
                        ...
                        case 0x10: // DJNZ d
                            ...
                            {
                                TotalExecutedCycles/*totalExecutedCycles*/ += 8; PendingCycles/*pendingCycles*/ -= 8;
                            }
                            break;
                        case 0x11: // LD DE, nn
                        ...
                        case 0x22: // LD (nn), HL
                            ...
                            RegWZ.Word = TUS;
                            TotalExecutedCycles/*totalExecutedCycles*/ += 16; PendingCycles/*pendingCycles*/ -= 16;
                            break;
                        case 0x23: // INC HL
                            ++RegHL.Word;
                            TotalExecutedCycles/*totalExecutedCycles*/ += 6; PendingCycles/*pendingCycles*/ -= 6;
                        ...
                        case 0xC0: // RET NZ
                            ...
                            {
                                TotalExecutedCycles/*totalExecutedCycles*/ += 5; PendingCycles/*pendingCycles*/ -= 5;
                            }
                            break;
                        case 0xC1: // POP BC
                        ...
                        case 0xCB: // (Prefix)
                            ...
                            switch (ReadOp(RegPC.Word++))
                            {
                                ...
                                case 0x05: // RLC L
                                    ...
                                    break;
                                case 0x06: // RLC (HL)
                                    TotalExecutedCycles/*totalExecutedCycles*/ += 15; PendingCycles/*pendingCycles*/ -= 15;
                        ...
                        case 0xDD: // (Prefix)
                            ...
                            switch (ReadOp(RegPC.Word++))
                            {
                                ...
                                case 0x21: // LD IX, nn
                                    ...
                                    TotalExecutedCycles/*totalExecutedCycles*/ += 14; PendingCycles/*pendingCycles*/ -= 14;
                                    break;
                                case 0x22: // LD (nn), IX
                                    TotalExecutedCycles/*totalExecutedCycles*/ += 20; PendingCycles/*pendingCycles*/ -= 20;
                                    TUS = (ushort)(ReadOpArg(RegPC.Word++) + ReadOpArg(RegPC.Word++) * 256);
                                ...
                                case 0x24: // INC IXH
                                    ...
                                    TotalExecutedCycles/*totalExecutedCycles*/ += 9; PendingCycles/*pendingCycles*/ -= 9;
                                    break;
                                case 0x25: // DEC IXH
                                ...
                                case 0x33: // INC SP
                                    ...
                                    break;
                                case 0x34: // INC (IX+d)
                                    TotalExecutedCycles/*totalExecutedCycles*/ += 23; PendingCycles/*pendingCycles*/ -= 23;
                                ...
                                case 0x86: // ADD A, (IX+d)
                                    ...
                                    TotalExecutedCycles/*totalExecutedCycles*/ += 19; PendingCycles/*pendingCycles*/ -= 19;//modify 16 to 19
                                    break;
                                case 0x87: // ADD A, A
                                    RegAF.Word = TableALU[0, RegAF.High, RegAF.High, 0];
                                    TotalExecutedCycles/*totalExecutedCycles*/ += 4; PendingCycles/*pendingCycles*/ -= 4;
                                ...
                                case 0xDD: // <-
                                    // Invalid sequence.
                                    TotalExecutedCycles/*totalExecutedCycles*/ += 1337; PendingCycles/*pendingCycles*/ -= 1337;
                                    break;
                                case 0xDE: // SBC A, n
                                ...
                                case 0xED: // (Prefix)
                                    ...
                                    switch (ReadOp(RegPC.Word++))
                                    {
                                        ...
                                        case 0x66: // IM $0
                                            ...
                                            break;
                                        case 0x67: // RRD
                                            TotalExecutedCycles/*totalExecutedCycles*/ += 18; PendingCycles/*pendingCycles*/ -= 18;
                                        ...
                                        case 0xB0: // LDIR
                                            ...
                                            if (RegBC.Word != 0)
                                            {
                                                ...
                                                TotalExecutedCycles/*totalExecutedCycles*/ += 21; PendingCycles/*pendingCycles*/ -= 21;
                                            }
                                            else
                                            {
                                                TotalExecutedCycles/*totalExecutedCycles*/ += 16; PendingCycles/*pendingCycles*/ -= 16;
                        ...
                        case 0xFD: // (Prefix)
                            ...
                            switch (ReadOp(RegPC.Word++))
                            {
                                ...
                                case 0x86: // ADD A, (IY+d)
                                    ...
                                    RegWZ.Word = (ushort)(RegIY.Word + Displacement);
                                    RegAF.Word = TableALU[0, RegAF.High, ReadMemory(RegWZ.Word), 0];
                                    TotalExecutedCycles/*totalExecutedCycles*/ += 19; PendingCycles/*pendingCycles*/ -= 19;//16
                                    break;
                                case 0x87: // ADD A, A
                                    RegAF.Word = TableALU[0, RegAF.High, RegAF.High, 0];
                                    TotalExecutedCycles/*totalExecutedCycles*/ += 4; PendingCycles/*pendingCycles*/ -= 4;
