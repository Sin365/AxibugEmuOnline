...
//	private readonly Dictionary<int, object> _cellData = new Dictionary<int, object>();
//	private readonly Dictionary<int, Sandbox.UI.Panel> _created = new Dictionary<int, Sandbox.UI.Panel>();
//	private readonly List<int> _removals = new List<int>();
