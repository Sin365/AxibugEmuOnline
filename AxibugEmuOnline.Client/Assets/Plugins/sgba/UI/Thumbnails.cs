...
//	private static readonly Dictionary<ThumbType, Task<Dictionary<string, string>>> IndexTasks = new Dictionary<ThumbType, Task<Dictionary<string, string>>>();
//	private static readonly Dictionary<string, Task<string>> ExactPathTasks = new Dictionary<string, Task<string>>();
//	private static readonly Dictionary<string, Task<string>> FallbackPathTasks = new Dictionary<string, Task<string>>();
//	private static readonly Dictionary<string, Texture> LoadedTextures = new Dictionary<string, Texture>();
