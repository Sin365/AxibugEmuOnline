...
//	private static readonly Dictionary<string, Task<FieldIndex>> FieldTasks = new Dictionary<string, Task<FieldIndex>>();
//	private static readonly Dictionary<string, Task<GameInfo>> LookupTasks = new Dictionary<string, Task<GameInfo>>();
