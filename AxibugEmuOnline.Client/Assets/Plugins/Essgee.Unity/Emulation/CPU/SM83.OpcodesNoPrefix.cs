namespace Essgee.Emulation.CPU
{
    public partial class SM83
    {
        static SimpleOpcodeDelegate[] opcodesNoPrefix = new SimpleOpcodeDelegate[]
        {
            ...
            new SimpleOpcodeDelegate((c) => { /*c.WriteMemory8( 手动内联*/ c.axiEMem.WriteMemory(c.hl.Word++, c.af.High); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.af.High = /*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.hl.Word++); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.LoadMemory8(c.hl.Word, /*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.pc++)); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.bc.High = /*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.hl.Word); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.bc.Low = /*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.hl.Word); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.de.High = /*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.hl.Word); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.de.Low = /*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.hl.Word); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.hl.High = /*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.hl.Word); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.hl.Low = /*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.hl.Word); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.Add8(/*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.hl.Word), false); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.Add8(/*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.hl.Word), true); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.Subtract8(/*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.hl.Word), false); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.Subtract8(/*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.hl.Word), true); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.And8(/*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.hl.Word)); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.Xor8(/*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.hl.Word)); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.Or8(/*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.hl.Word)); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.Cp8(/*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.hl.Word)); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.Add8(/*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.pc++), false); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.Add8(/*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.pc++), true); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.Subtract8(/*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.pc++), false); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.CallConditional16(c.IsFlagSet(Flags.Carry)); }),
            new SimpleOpcodeDelegate((c) => { c.pc--; }),
            new SimpleOpcodeDelegate((c) => { c.Subtract8(/*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.pc++), true); }),
            new SimpleOpcodeDelegate((c) => { c.Restart(0x0018); }),
			/* 0xE0 */
			new SimpleOpcodeDelegate((c) => { /*c.WriteMemory8( 手动内联*/ c.axiEMem.WriteMemory((ushort)(0xFF00 + /*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.pc++)), c.af.High); }),
            new SimpleOpcodeDelegate((c) => { c.Pop(ref c.hl); }),
            new SimpleOpcodeDelegate((c) => { /*c.WriteMemory8( 手动内联*/ c.axiEMem.WriteMemory((ushort)(0xFF00 + c.bc.Low), c.af.High); }),
            new SimpleOpcodeDelegate((c) => { c.pc--; }),
            new SimpleOpcodeDelegate((c) => { c.pc--; }),
            new SimpleOpcodeDelegate((c) => { c.Push(c.hl); }),
            new SimpleOpcodeDelegate((c) => { c.And8(/*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.pc++)); }),
            new SimpleOpcodeDelegate((c) => { c.Restart(0x0020); }),
            new SimpleOpcodeDelegate((c) => { c.AddSPNN(); }),
            new SimpleOpcodeDelegate((c) => { c.pc = c.hl.Word; }),
            new SimpleOpcodeDelegate((c) => { /*c.WriteMemory8( 手动内联*/ c.axiEMem.WriteMemory(c.ReadMemory16(c.pc), c.af.High); c.pc += 2; }),
            new SimpleOpcodeDelegate((c) => { c.pc--; }),
            new SimpleOpcodeDelegate((c) => { c.pc--; }),
            new SimpleOpcodeDelegate((c) => { c.pc--; }),
            new SimpleOpcodeDelegate((c) => { c.Xor8(/*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.pc++)); }),
            new SimpleOpcodeDelegate((c) => { c.Restart(0x0028); }),
			/* 0xF0 */
			new SimpleOpcodeDelegate((c) => { c.af.High = /*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory((ushort)(0xFF00 + /*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.pc++))); }),
            new SimpleOpcodeDelegate((c) => { c.PopAF(); }),
            new SimpleOpcodeDelegate((c) => { c.af.High = /*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory((ushort)(0xFF00 + c.bc.Low)); }),
            new SimpleOpcodeDelegate((c) => { c.DisableInterrupts(); }),
            new SimpleOpcodeDelegate((c) => { c.pc--; }),
            new SimpleOpcodeDelegate((c) => { c.Push(c.af); }),
            new SimpleOpcodeDelegate((c) => { c.Or8(/*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.pc++)); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.af.High = /*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.ReadMemory16(c.pc)); c.pc += 2; }),
            new SimpleOpcodeDelegate((c) => { c.EnableInterrupts(); }),
            new SimpleOpcodeDelegate((c) => { c.pc--; }),
            new SimpleOpcodeDelegate((c) => { c.pc--; }),
            new SimpleOpcodeDelegate((c) => { c.Cp8(/*c.ReadMemory8( 手动内联*/ c.axiEMem.ReadMemory(c.pc++)); }),
