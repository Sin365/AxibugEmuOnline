...
namespace StoicGoose.Core.Machines
{
    public abstract class MachineCommon : IMachine, IMemoryAccessComponent, IPortAccessComponent
    {
        ...
        public string InternalEepromDefaultUsername;// { get; }//!
        public Dictionary<ushort, byte> InternalEepromDefaultData;// { get; }//!

        public const double MasterClock = 12288000.0; /* 12.288 MHz xtal */
        public const double CpuClock = MasterClock / 4.0; /* /4 = 3.072 MHz */

        public int InternalRamSize;//{ get; }//!
        public uint InternalRamMask = 0;
        public byte[] InternalRam = default;

        public Cartridge Cartridge = new Cartridge();
        public V30MZ Cpu = default;
        public DisplayControllerCommon DisplayController = default;
        public SoundControllerCommon SoundController = default;
        public EEPROM InternalEeprom = default;
        public Bootstrap BootstrapRom = default;
        public SerialPort Serial = default;

        public int InternalEepromSize;// { get; }//!
        public int InternalEepromAddressBits;// { get; }//!

        public int BootstrapRomAddress;// { get; }//!
        public int BootstrapRomSize;// { get; }//!

        //public Func<(List<string> buttonsPressed, List<string> buttonsHeld)> ReceiveInput { get; set; } = default;
        public Func<long> ReceiveInput = default;

        public Func<uint, byte, byte> ReadMemoryCallback = default;
        public Action<uint, byte> WriteMemoryCallback = default;
        public Func<ushort, byte, byte> ReadPortCallback = default;
        public Action<ushort, byte> WritePortCallback = default;
        public Func<bool> RunStepCallback = default;

        protected bool cancelFrameExecution = false;

        public int CurrentClockCyclesInLine = 0;
        public int CurrentClockCyclesInFrame = 0;

        public int TotalClockCyclesInFrame = 0;
        ...
        public bool IsBootstrapLoaded = false;
