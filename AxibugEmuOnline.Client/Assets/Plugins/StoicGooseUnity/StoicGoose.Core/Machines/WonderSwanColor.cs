...
namespace StoicGoose.Core.Machines
{
    public partial class WonderSwanColor : MachineCommon
    {
        ...
        {
            Manufacturer = "Bandai";
            Model = "WonderSwan Color";
            InternalEepromDefaultUsername = "WONDERSWANCOLOR";
            InternalEepromDefaultData = new Dictionary<ushort, byte>()
        {
            { 0x70, 0x20 }, // Year of birth [set to WSC release date for fun]
			{ 0x71, 0x00 }, // ""
			{ 0x72, 0x12 }, // Month of birth [again]
            ...
            InternalEepromSize = 1024 * 2;
            InternalEepromAddressBits = 10;
            BootstrapRomAddress = 0xFE000;
            BootstrapRomSize = 0x2000;
        }
