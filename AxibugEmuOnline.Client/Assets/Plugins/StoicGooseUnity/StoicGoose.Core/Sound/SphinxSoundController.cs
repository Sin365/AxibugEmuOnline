...
namespace StoicGoose.Core.Sound
{
    public class SphinxSoundController : SoundControllerCommon
    {
        ...
        public SphinxSoundController(MachineCommon machine, int rate, int outChannels) : base(machine, rate, outChannels, 3, 5)
        {
        ...
        public override GenerateSampleResult GenerateSample()
        {
            ...
            /* 不需要分开channel的mix记录
            channelSampleBuffersAdd(0,((short)(channel1.IsEnabled ? (channel1.OutputLeft & 0x07FF) << 5 : 0)));
            channelSampleBuffersAdd(0,((short)(channel1.IsEnabled ? (channel1.OutputRight & 0x07FF) << 5 : 0)));
            channelSampleBuffersAdd(1,((short)(channel2.IsEnabled ? (channel2.OutputLeft & 0x07FF) << 5 : 0)));
            channelSampleBuffersAdd(1,((short)(channel2.IsEnabled ? (channel2.OutputRight & 0x07FF) << 5 : 0)));
            channelSampleBuffersAdd(2,((short)(channel3.IsEnabled ? (channel3.OutputLeft & 0x07FF) << 5 : 0)));
            channelSampleBuffersAdd(2,((short)(channel3.IsEnabled ? (channel3.OutputRight & 0x07FF) << 5 : 0)));
            channelSampleBuffersAdd(3,((short)(channel4.IsEnabled ? (channel4.OutputLeft & 0x07FF) << 5 : 0)));
            channelSampleBuffersAdd(3,((short)(channel4.IsEnabled ? (channel4.OutputRight & 0x07FF) << 5 : 0)));
            channelSampleBuffersAdd(4,((short)(channelHyperVoice.IsEnabled ? (channelHyperVoice.OutputLeft & 0x07FF) << 5 : 0)));
            channelSampleBuffersAdd(4,((short)(channelHyperVoice.IsEnabled ? (channelHyperVoice.OutputRight & 0x07FF) << 5 : 0)));
            */
